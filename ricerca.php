<?php
    ...
    $type = $_GET['type'];
    $curl = curl_init();
    curl_setopt($curl, CURLOPT_URL, "https://api.themoviedb.org/3/search/".$type."?api_key=".$key."&language=it&page=1&include_adult=false&query=".$titolo."&sort_by=popularity.desc");
